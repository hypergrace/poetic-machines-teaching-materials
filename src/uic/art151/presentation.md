...
- title: Generative Art
  artists:
      ...
      - name: Stephanie Dinkins
        url: https://www.stephaniedinkins.com/
      - name : Casey Reas
        url : https://reas.com/
      - name: Tega Brain
        url: https://tegabrain.com/about
      - name : Memo Atken 
        url: https://www.memo.tv/
      - name: Zach Blas
        url: https://zachblas.info/
...
- title: Games & Simulation
  artists:
      ...
      - name: Daniel Benmergui
        url: https://danielben.itch.io/
      - name: Cory Archangel
        url: https://coryarcangel.com/
      - name: Erik Svedang
        url: https://www.eriksvedang.com/
      - name: Everest Pipkin
